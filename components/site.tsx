    ...
    <div className="container demo-grid">
      <div className="demo-info">
        ...
        <div className="demo-contact-list">
          ...
          <div><span className="icon-box"><PhoneCall size={18} /></span><div><small>Contact number</small><a href="tel:+911204539428">+91 120 453 9428</a></div></div>
