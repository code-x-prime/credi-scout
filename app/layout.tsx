...
import './globals.css'
import { SiteReveal } from '@/components/site'
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" className={manrope.variable}><body className="antialiased">{children}<SiteReveal/>{process.env.NODE_ENV==='production'&&<Analytics/>}</body></html>}
