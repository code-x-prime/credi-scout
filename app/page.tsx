...
export default function Home() {
  return <><Header/><main><HomeHero/><TrustStrip/>
    <section className="section intro compact-section"><div className="container split-section">
